...
const Annotator = dynamic(() => import('@/components/annotator-c'), { ssr: false, loading: () => <div className="h-screen bg-zinc-950" /> })
...
export default function PageC() {
  ...
  return <UploadScreen onFile={handleFile} versionLabel="Version C — Floating Controls" />
}
