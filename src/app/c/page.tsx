...
const Annotator = dynamic(() => import('@/components/annotator-f'), { ssr: false, loading: () => <div className="h-screen bg-zinc-950" /> })
...
export default function PageC() {
  ...
  return <UploadScreen onFile={handleFile} versionLabel="Mobile Prototype C" />
}
