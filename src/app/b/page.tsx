...
const Annotator = dynamic(() => import('@/components/annotator-b'), { ssr: false, loading: () => <div className="h-screen bg-zinc-950" /> })
...
export default function PageB() {
  ...
  return <UploadScreen onFile={handleFile} versionLabel="Version B — Left Sidebar" />
}
