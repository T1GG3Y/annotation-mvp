...
const Annotator = dynamic(() => import('@/components/annotator-a'), { ssr: false, loading: () => <div className="h-screen bg-zinc-950" /> })
...
export default function PageA() {
  ...
  return <UploadScreen onFile={handleFile} versionLabel="Version A — Top Toolbar" />
}
