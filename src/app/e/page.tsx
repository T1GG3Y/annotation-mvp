...
const Annotator = dynamic(() => import('@/components/annotator-e'), { ssr: false, loading: () => <div className="h-screen bg-zinc-950" /> })
...
export default function PageE() {
  ...
  return <UploadScreen onFile={handleFile} versionLabel="Version E — Damage Visibility" />
}
